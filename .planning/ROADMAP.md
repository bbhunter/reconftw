...
- [ ] 01-03: `PARALLEL_JOB_TIMEOUT_SECONDS` enforcement in `lib/parallel.sh` plus DNS timeout defaults in `reconftw.cfg` (RESIL-03, PERF-02)
...
|-------|----------------|--------|-----------|
| 1. Resilient Resume & Timeout Safety | 0/3 | Not started | - |
